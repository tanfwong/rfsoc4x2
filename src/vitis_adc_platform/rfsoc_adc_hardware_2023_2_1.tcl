...
#
# Generated by Vivado on Mon Dec 25 21:40:09 UTC 2023
...
set_property -name "platform.description" -value "Hardware emulation file for an extensible platform with 1 ADC on the RFSoC4x2 board" -objects $obj
...
set_property -name "platform.vendor" -value "tanfwong" -objects $obj
...
\
  ...
  connect_bd_net -net zynq_ultra_ps_e_0_pl_clk0 [get_bd_pins zynq_ultra_ps_e_0/pl_clk0] [get_bd_pins axi_intc_0/s_axi_aclk] [get_bd_pins clk_wiz_0/clk_in1] [get_bd_pins ps8_0_axi_periph/ACLK] [get_bd_pins ps8_0_axi_periph/S00_ACLK] [get_bd_pins ps8_0_axi_periph/M00_ACLK] [get_bd_pins ps8_0_axi_periph/M01_ACLK] [get_bd_pins usp_rf_data_converter_0/s_axi_aclk] [get_bd_pins zynq_ultra_ps_e_0/maxihpm0_lpd_aclk]
  connect_bd_net -net zynq_ultra_ps_e_0_pl_resetn0 [get_bd_pins zynq_ultra_ps_e_0/pl_resetn0] [get_bd_pins clk_wiz_0/resetn] [get_bd_pins proc_sys_reset_clk_out200M/ext_reset_in] [get_bd_pins proc_sys_reset_clk_adc0/ext_reset_in] [get_bd_pins axi_intc_0/s_axi_aresetn] [get_bd_pins proc_sys_reset_clk_out400M/ext_reset_in] [get_bd_pins ps8_0_axi_periph/ARESETN] [get_bd_pins ps8_0_axi_periph/S00_ARESETN] [get_bd_pins ps8_0_axi_periph/M00_ARESETN] [get_bd_pins ps8_0_axi_periph/M01_ARESETN] [get_bd_pins usp_rf_data_converter_0/s_axi_aresetn]
  ...
  regenerate_bd_layout -layout_string {
   ...
   "Default View_ScaleFactor":"0.309278",
   "Default View_TopLeft":"-113,-382",
...
preplace netloc clk_wiz_0_clk_out2 1 2 1 N 240
preplace netloc clk_wiz_0_locked 1 2 1 1000 140n
...
"
  ...
  set_property PFM_NAME {tanfwong:rfsoc4x2:rfsoc_adc_hardware:0.0} [get_files [current_bd_design].bd]
...
set_property PFM_NAME "tanfwong:rfsoc4x2:rfsoc_adc_hardware:0.0" [get_files system.bd ] 
...
set_property -name "auto_incremental_checkpoint.directory" -value "$proj_dir/rfsoc_adc_hardware.srcs/utils_1/imports/synth_1" -objects $obj
...
set_property -name "auto_rqs.directory" -value "$proj_dir/rfsoc_adc_hardware.srcs/utils_1/imports/impl_1" -objects $obj
set_property -name "incremental_checkpoint.more_options" -value "" -objects $obj
set_property -name "include_in_archive" -value "1" -objects $obj
set_property -name "gen_full_bitstream" -value "1" -objects $obj
set_property -name "auto_incremental_checkpoint.directory" -value "$proj_dir/rfsoc_adc_hardware.srcs/utils_1/imports/impl_1" -objects $obj
set_property -name "min_rqa_score" -value "0" -objects $obj
