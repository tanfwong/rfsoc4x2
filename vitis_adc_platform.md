...
4. Boot up the RFSoC board from an SD card:
...
5. Configure and turn on the reference clock chips (LMK04828 and LMX2594) via SPI:
...
6. Run the `test_adc` app to grab samples from the ADC:
   ```shell
